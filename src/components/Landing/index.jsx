  ...
  return (
    <motion.main variants={slideUp} initial="initial" animate="enter" className={styles.landing}>
      ...
      <div className={styles.sliderContainer} >
        ...
        <h1 className='md:hidden block text-black items-start font-boldold text-2xl p-2 relative '>
          <p>Freelance</p>
      ...
      <div data-scroll data-scroll-speed={0.1} className={styles.description}>
        <svg color="black" fil width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
