            ...
            <body class="bg-gradient-to-r from-slate-700 to-black-800 min-h-screen text-white">
                ...
                <main class="container mx-auto px-6 py-12">
                    <section id="about" class="mb-20 animate-fade-in-up" >
                        <h1 class="text-4xl md:text-6xl font-bold mb-4">Hi, I'm Muhammad Hamid</h1>
                        <p class="text-xl mb-8">A passionate web developer and designer creating beautiful, functional websites.</p>
                        <p> I began my journey in software development during my college years, where I built a strong foundation in Object-Oriented Programming (OOP) using C and C++. Over time, I transitioned into the modern tech stack, mastering JavaScript, TypeScript, and Python. My passion for development now lies in creating full-stack applications, leveraging cutting-edge technologies like Next.js to build dynamic, scalable, and user-friendly interfaces.</p>

                        <p>   I have hands-on experience in developing cloud-native applications, where I apply an event-driven architecture for creating scalable and reliable systems. My tech stack includes:</p>
                    </section>
                    ...
                    <section id="projects" class="mb-20 animate-fade-in-up">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="bg-white bg-opacity-10 p-6 rounded-lg backdrop-filter backdrop-blur-lg hover:bg-opacity-20 transition-all duration-300 transform hover:scale-105">
                                ...
                                <p class="mb-4">A fully functional online store built with React and Node.js.</p>
                                <a href="#" class="text-indigo-300 hover:text-indigo-100 transition-colors duration-300">View Project →</a>
                            </div>
                            <div class="bg-white bg-opacity-10 p-6 rounded-lg backdrop-filter backdrop-blur-lg hover:bg-opacity-20 transition-all duration-300 transform hover:scale-105">
                                <h3 class="text-xl font-semibold mb-2">Portfolio Template</h3>
                                <p class="mb-4">A customizable portfolio website template for creatives.</p>
                                <a href="#" class="text-indigo-300 hover:text-indigo-100 transition-colors duration-300">View Project →</a>
                            </div>
                        </div>
                    </section>
                ...
                <footer class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg mt-12">
                    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
                        ...
                        <div class="flex space-x-4">
                            <Link href="https://github.com/hamidkhans651" class="hover:text-indigo-300 transition-colors duration-300">
                            ...
                            <Link href="https://www.linkedin.com/in/muhammad-hamid-a0426a1b5/" class="hover:text-indigo-300 transition-colors duration-300">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
